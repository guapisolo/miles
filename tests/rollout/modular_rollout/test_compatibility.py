...
def test_load_class(constructor_input):
...
def test_load_function_returns_adapter(constructor_input):
    def mock_fn():
        pass
...
def test_adapter_call_with_train_input_wraps_output(constructor_input):
...
def test_adapter_passthrough_train_output(constructor_input):
...
def test_adapter_passthrough_eval_output(constructor_input):
